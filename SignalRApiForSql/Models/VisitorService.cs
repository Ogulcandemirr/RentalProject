...
namespace SignalRApiForSql.Models
{
    public class VisitorService
    {
        ...
        public List<VisitorChart> GetVisitorChartList()
        {
            ...
            {
                command.CommandText = "select tarih,[1],[2],[3],[4],[5] from(select[Car],CarRentCount,Cast([Date]as Date) as tarih from Visitors)as visitTable Pivot (Sum(CarRentCount) For Car in([1],[2],[3],[4],[5])) as pivotTable order by tarih asc";
